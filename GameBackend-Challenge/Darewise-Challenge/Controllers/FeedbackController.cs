...
namespace Darewise_Challenge.Controllers
{
    ...
    public class FeedbackController : ControllerBase
    {
        ...
        public FeedbackController(ApplicationDbContext appDbContext, ILogger<BugController> logger, IMapper mapper, IFilesManager filesManager)
        {
        ...
        {
            return await appDbContext.Feedbacks.Include(x => x.Player).ToListAsync();
        }
        ...
        {
            var bug = await appDbContext.Feedbacks.FirstOrDefaultAsync(x => x.Id == id);
